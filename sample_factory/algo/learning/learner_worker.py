...
from sample_factory.algo.learning.learner_factory import create_learner
...
class LearnerWorker(HeartbeatStoppableEventLoopObject, Configurable):
    def __init__(
        ...
        self.learner = create_learner(cfg, env_info, policy_versions_tensor, policy_id, self.param_server)
        # import pdb; pdb.set_trace()  # TODO: delete this line
    ...
    def init(self):
        ...
        self.report_msg.emit({LEARNER_ENV_STEPS: self.learner.env_steps, 
